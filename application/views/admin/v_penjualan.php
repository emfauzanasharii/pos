    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="form-group">
                 <label for="inputUserName" class="col-sm-5 control-label" style="font-size: 20px">Kode Barang/Nama Barang</label>
               <div class="col-sm-5">
                    <input type="text" name="kode_brg" id="kode_brg" class="form-control input-md" placeholder="Kode Barang/Nama Barang" required>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <table class="table table-bordered table-condensed" style="font-size:16px;margin-top:10px; margin-bottom: 45px;">
                ...
                <tbody>
                    ...
                    <tr>
                         ...
                         <td style="text-align:center;"><a href="<?php echo base_url().'admin/penjualan/remove/'.$items['rowid'];?>" class="btn btn-danger btn-sm"><span class="fa fa-close"></span> Batal</a></td>
                    </tr>
            ...
            <table style="font-size:20px;">
                ...
                <tr>
                    <th>Tunai(Rp)</th>
                    <th style="text-align:right;"><input type="text" id="jml_uang" name="jml_uang" class="jml_uang form-control input-lg" style="text-align:right;margin-bottom:10px;"  onkeypress='return check_int(event)' required></th>
                ...
                <tr>
                    <th>Kembalian(Rp)</th>
                    <th style="text-align:right;"><input type="text" id="kembalian" name="kembalian" class="kembalian form-control input-lg" style="text-align:right;margin-bottom:10px;" required readonly></th>
                    
                </tr>
               
            </table>
            <div>
                 <button button type="submit" class="btn btn-success btn-lg btn-block" alig>SIMPAN</button>
            </div>
            </form>
            </div>
