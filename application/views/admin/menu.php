                ...
                <ul class="nav navbar-nav">
                   <?php $h=$this->session->userdata('akses'); ?>
                    ...
                    <?php if($h=='1'){ ?> 
                     <!--dropdown-->
                    <li class="dropdown">
                        <a href="<?php echo base_url().'admin/penjualan'?>"  role="button" aria-haspopup="true" aria-expanded="false" title="Transaksi"><span class="fa fa-shopping-cart" aria-hidden="true"></span> Transaksi</a>
                       <!--  <ul class="dropdown-menu">
                            <li><a href="<?php echo base_url().'admin/penjualan'?>"><span class="fa fa-shopping-bag" aria-hidden="true"></span> Transaksi Penjualan</a></li> 
