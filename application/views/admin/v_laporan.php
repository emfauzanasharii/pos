   ...
   ?>
    ...
    <div class="container">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; width: 200px">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/laporan/lap_data_barang'?>" ><span class="fa fa-eye"></span> Lihat</a>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/laporan/cetak_lap_data_barang'?>" ><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/laporan/laporan_stock'?>" ><span class="fa fa-eye"></span> Lihat</a>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/laporan/cetak_lap_stok_barang'?>" ><span class="fa fa-print"></span> Print</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <a class="btn btn-sm btn-info" href="<?php echo base_url().'admin/laporan/lap_data_penjualan'?>" ><span class="fa fa-eye"></span> Lihat</a>
                            <a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/laporan/cetak_lap_data_penjualan'?>" ><span class="fa fa-print"></span> Print</a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a class="btn btn-sm btn-info" href="#lap_jual_perbulan" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            ...
                            <a class="btn btn-sm btn-info" href="#lap_jual_pertahun" data-toggle="modal"><span class="fa fa-print"></span> Print</a>
                        </td>
                    </tr>
        ...
        <div class="modal fade" id="lap_jual_pertanggal" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/laporan/lap_penjualan_pertanggal'?>" >
